...
def test_local_model(spec: dict, test_prompt: str = "Hello, world!") -> dict:
    """Test loading and running a local model with a simple prompt.
    
    Args:
        spec: Same as for load_local_model()
    ...
    try:
        model = load_local_model(spec)
        result["load_time_seconds"] = time.time() - start_time
        result["model_info"] = model.model_info
        ...
        result["generation_result"] = {
            ...
            "time_seconds": gen_result.time_seconds,
        }
